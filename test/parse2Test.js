...
describe('Parse', () => {
  describe('build', () => {
    ...
    it("link css", () => {
      let home = '<link href="home.css" type="text/css" compressed/>';
      let comps = { home };

      var parse = new Parse(home, {
        path: './example/components/home.html',
        rootDir: './example/components',
        namespace: 'pds-home'
      }).build();

      assert.equal(parse.toHtml({}, comps), '<style type="text/css">.test{color:#fff}#hello .me,.today{font-size:12px}.home,.jail{float:left}div.home .hmmm{clear:both}\n</style>');
    });

    it("link css namespaced", () => {
      let home = '<div class="test"><link href="home.css" type="text/css" compressed namespaced/></div>';
      let comps = { home };
      ...
      assert.equal(parse.toHtml({}, comps), '<div class="test pds-home"><style type="text/css">.pds-home.test, .pds-home .test{color:#fff}.pds-home #hello .me,.pds-home .today{font-size:12px}.pds-home .home,.pds-home .jail{float:left}div.pds-home.home, ,.hmmm, .pds-home div.home .hmmm{clear:both}\n</style></div>');
    });
